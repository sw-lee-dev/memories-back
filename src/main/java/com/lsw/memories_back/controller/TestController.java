...
import com.lsw.memories_back.service.TestService;
...
public class TestController {
  ...
  public ResponseEntity<? super GetRecentlyConcentrationResponeDto> getRecentlyConcentration(
    @AuthenticationPrincipal String userId
  ) {
    ResponseEntity<? super GetRecentlyConcentrationResponeDto> response = testService.getRecentlyConcentration(userId);
    return response;
  }
