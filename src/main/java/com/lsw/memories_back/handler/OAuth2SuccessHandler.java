package com.lsw.memories_back.handler;
...
import com.lsw.memories_back.common.entity.CustomOAuth2User;
...
// class: OAuth2 유저 서비스 작업이 성공했을때의 처리를 담당하는 클래스 //
@Component
public class OAuth2SuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
  ...
  @Override
    ...
    if (existed) {
      ...
      cookie.setPath("/");
      // description: JS 사용 여부 (false가 사용 O) //
