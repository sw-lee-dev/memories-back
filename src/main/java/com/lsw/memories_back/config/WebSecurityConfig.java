...
import com.lsw.memories_back.filter.JwtAuthenticationFilter;
import com.lsw.memories_back.service.implement.OAuth2UserServiceImplement;

import lombok.RequiredArgsConstructor;

// class: Spring Web 보안 설정 //
// description: Bearer 인증 방식을 사용하기 위해 Basic 인증 미사용으로 변경 //
// description: REST API 서버로 Session 유지하지 않도록 설정 //
// description: CORS 정책은 모든 출처 및 리소스에 대해서 허용하도록 설정 //
@Configurable
@Configuration
@EnableWebSecurity
